  ...
  const fetchGroup = async () => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || errorData.message || 'Failed to fetch group');
      }
    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
      ...
      <div className="dashboard-card" style={{ marginBottom: '2rem' }}>
        ...
        <div style={{
          ...
          <div>
            <strong>Members:</strong> {group.members ? group.members.length : 0} / {group.maxMembers}
          </div>
          <div>
      ...
      {isMember && (
        <div className="dashboard-card">
          <h3>Group Members</h3>
          <p>As a member of this group, you can see who else is participating.</p>
          {/* TODO: Fetch and display member details */}
          <p style={{ fontStyle: 'italic', color: 'var(--text-secondary)' }}>
            Member details will be displayed here once user profiles are implemented.
          </p>
        </div>
      )}
    </div>
